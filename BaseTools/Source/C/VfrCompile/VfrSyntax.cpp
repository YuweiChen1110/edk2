 ...
 *
 *   C:\Users\yuweiche\Code\Dev\edk2\BaseTools\Bin\Win32\antlr.EXE -CC -e3 -ck 3 -k 2 -fl VfrParser.dlg -ft VfrTokens.h -o . VfrSyntax.g
 *
 */
...
EfiVfrParser::vfrFormSetDefinition(void)
{
 ...
 consume();
      ...
      classDefinition( C );
      zzmatch(156);
      {CIfrClass CObj;SET_LINE_INFO (CObj, FC); CObj.SetClass(C); CObj.CollectNodeInfo();}
 consume();
    }
    else {
      if ( (setwd7[LA(1)]&0x8) ) {
 ...
 consume();
      ...
      zzmatch(156);
      {CIfrSubClass SCObj; SET_LINE_INFO (SCObj, FSC); SCObj.SetSubClass(SC); SCObj.CollectNodeInfo();}
 consume();
    }
    else {
      if ( (setwd7[LA(1)]&0x10) ) {
...
EfiVfrParser::vfrFormMapDefinition(void)
{
 ...
 consume();
      ...
      guidDefinition( Guid );
      zzmatch(161);
      FMapObj->SetFormMapMethod (_STOFID(S2->getText(), S2->getLine()), &Guid); FormMapMethodNumber ++; FMapObj->CollectNodeInfo();
 consume();
    }
  }
...
EfiVfrParser::vfrStatementSubTitle(void)
{
 ...
 consume();
  zzmatch(CloseParen);
  SObj.SetPrompt (_STOSID(S->getText(), S->getLine())); SObj.CollectNodeInfo();
 consume();
  {
...
EfiVfrParser::vfrStatementOrderedList(void)
{
 ...
 consume();
  ...
  OLObj.CollectNodeInfo(); CRT_END_OP (E); gIsOrderedList = FALSE;
 consume();
  zzmatch(161); consume();
  return;
fail:
...
{
  zzRULE;
  ANTLRTokenPtr L=NULL, E=NULL, C=NULL;
  CIfrSuppressIf SIObj;
  UINT8 CoCount = 0;
  ANTLRChar tempstr[300] = "";
  zzmatch(SuppressIf);
  L = (ANTLRTokenPtr)LT(1);
 ...
 consume();
  {
    if ( (LA(1)==FLAGS) ) {
      ...
      if ( (setwd32[LA(1)]&0x2) ){
        while(LA(1) != 161){
          ...
          else if ((LA(1)==StringIdentifier)){
            zzmatch(StringIdentifier);
            C = (ANTLRTokenPtr)LT(1);
            printf("StringIdentifier: %s\n", C->getText());
            strcat(tempstr, C->getText());
            consume();
          }
          else if ((LA(1)==170)){
    ...
    printf("TestTest: %s\n", tempstr);
    SIObj.SetCondition(tempstr);
  zzmatch(161); consume();
  {
    while ( (setwd32[LA(1)]&0x4)
 ) {
      printf("Here is a entry.\n");
      vfrStatementStatList();
    }
...
EfiVfrParser::vfrImageTag(void)
{
 ...
 consume();
  zzmatch(CloseParen);
  IObj.SetImageId (_STOSID(S1->getText(), S1->getLine())); IObj.SetLineNo(L->getLine()); IObj.CollectNodeInfo();
 consume();
  return;
fail:
  syn(zzBadTok, (ANTLRChar *)"", zzMissSet, zzMissTok, zzErrk);
...
EfiVfrParser::vfrStatementRefresh(void)
{
 ...
 consume();
  ...
  RObj.SetRefreshInterval (_STOU8(I->getText(), I->getLine())); RObj.CollectNodeInfo();
 consume();
  return;
fail:
  syn(zzBadTok, (ANTLRChar *)"", zzMissSet, zzMissTok, zzErrk);
...
EfiVfrParser::vfrStatementRefreshEvent(void)
{
 ...
 consume();
  zzmatch(167); consume();
  guidDefinition( Guid );
  RiObj.SetRefreshEventGroutId (&Guid); RiObj.CollectNodeInfo();
  return;
fail:
  syn(zzBadTok, (ANTLRChar *)"", zzMissSet, zzMissTok, zzErrk);
  resynch(setwd37, 0x2);
...
EfiVfrParser::vfrStatementVarstoreDevice(void)
{
 ...
 consume();
  zzmatch(CloseParen); consume();
  zzmatch(156);
  VDObj.SetDevicePath (_STOSID(S->getText(), S->getLine())); VDObj.CollectNodeInfo();
 consume();
  return;
fail:
  syn(zzBadTok, (ANTLRChar *)"", zzMissSet, zzMissTok, zzErrk);
...
EfiVfrParser::vfrStatementExpression(UINT32 RootLevel,UINT32 ExpOpCount)
{
  ...
  printf("tttttttttttttttttttttttttttttt: %d\n", ExpOpCount);
